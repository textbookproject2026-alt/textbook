...
Retroduction is the mode of inference that makes it possible to investigate unobservable mechanisms. Rather than moving from causes to predicted effects, it works backward — from observed effects to the conditions that must exist for those effects to be possible.
