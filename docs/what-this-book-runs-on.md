...
| **The weekly workflows** | snapshot (a `snapshot-YYYY-MM-DD` tag), backup, contributors, derivatives, dashboard, link check, the weekly config render | this repository | `community/` pages go stale | [SCHEDULED-JOBS.md](https://github.com/textbookproject2026-alt/textbook-registry/blob/main/docs/SCHEDULED-JOBS.md), Part 2 |
